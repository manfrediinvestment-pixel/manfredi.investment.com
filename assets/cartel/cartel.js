...
var q=new URLSearchParams(location.search), RM=!!(window.matchMedia&&matchMedia('(prefers-reduced-motion: reduce)').matches), fixed=q.has('cartel')||RM, STATIC=fixed; // movimiento reducido = cartel quieto, sin autoplay
...
var cards=PAGES.map(function(p){var c=el('div','pgc','<img alt="" loading="lazy" decoding="async" src="'+p[0]+'">'); stack.appendChild(c); return c;});
